...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      Yangiliklarni Olish Uchun Obuna Bo&apos;sling
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Bizning yangiliklarimiz va yangilanishlarimizdan birinchi bo&apos;slib xabardor bo&apos;slishni xohlaysizmi? 
      Bizning botimiz sizga yangiliklarni yuboradi
      </p>
      <div>
        <input
          type="text"
   ...
   Hozir obuna bo&apos;sling va biz bilan qoling!
        </p>
      </div>
